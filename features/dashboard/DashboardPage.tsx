    ...
    <DashboardLayout>
      ...
      {activeTab === "dashboard" ? (
        <div className="px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <DashboardCard title="Current Affairs">
            <div className="flex items-center gap-4 py-2">
              ...
              <p className="text-white/40 text-sm">No new updates today.</p>
            </div>
          </DashboardCard>
          ...
          <DashboardCard title="Daily Answer Writing">
            <div className="flex items-center gap-4 py-2">
              ...
              <p className="text-white/40 text-sm">Next topic at 9:00 AM.</p>
            </div>
          </DashboardCard>
        </div>
      ) : activeTab === "sprint" ? (
        ...
        <div className="px-6 py-20 flex flex-col items-center justify-center text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-white uppercase tracking-widest">{activeTab} Coming Soon</h2>
          <p className="text-white/40 max-w-xs">We are currently building this feature. Stay tuned!</p>
        </div>
      )}
    </DashboardLayout>
  );
...
// Internal alias for cleaner structure in this file if needed, but I'll use the imported ones
